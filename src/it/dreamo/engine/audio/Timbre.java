...
public class Timbre extends FeaturesExtractor
{
  ...
  private final float COMPLEXITY_THRESHOLD_COEFF=1.5f;
  ...
  private void calcSpectralCentroid()
  {
    ...
    SC=PApplet.map(SC,CENTROID_THEORETICAL_MIN,CENTROID_THEORETICAL_MAX,0,1);
  ...
  {  
    if(avgMagnitude>0.5)
    {
      ...
      spectralComplexity=PApplet.map(bins,COMPLEXITY_THEORETICAL_MIN,COMPLEXITY_THEORETICAL_MAX,0,1);
